...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            try {
                printer.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.1.100", 9100);
                printer.resetPrinter();
                printer2.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.1.101", 9100);
                printer2.resetPrinter();
//                printer.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.20.33", 9100);
            } catch (Exception e) {
                e.printStackTrace();
                Log.d("daon", "print1 error = "+e.getMessage());
            }

            if (!printer.IsConnected(Sam4sPrint.DEVTYPE_ETHERNET)){
                try {

                    Log.d("daon", "print1 error = "+printer.getPrinterStatus());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }else{
    ...
    public void setPrinter(){
        ...
        try {
            try {
                printer.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.1.100", 9100);
                printer.resetPrinter();
                printer2.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.0.11", 9100);
                printer2.resetPrinter();
            } catch (Exception e) {
                e.printStackTrace();
                Log.d("daon", "print1 error = "+e.getMessage());
